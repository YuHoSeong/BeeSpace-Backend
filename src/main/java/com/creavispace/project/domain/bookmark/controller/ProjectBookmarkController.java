...
public class ProjectBookmarkController {
    ...
    private static final String PROJECT_BOOKMARK = "";

    @PostMapping(PROJECT_BOOKMARK)
    @Operation(summary = "프로젝트 북마크 토글 기능")
    public ResponseEntity<SuccessResponseDto<ProjectBookmarkResponseDto>> projectBookmark(@RequestParam("projectId") Long projectId) {
